        ...
        <div class="container">
            <div
                ...
                <div
                    ...
                    class="pricing-switcher center-content invert-color"
                >
                    <c-switch
                ...
                <div
                    v-if="pricingSlider"
                    class="pricing-slider center-content invert-color"
                >
                            ...
                            <div class="pricing-item-content">
                                <div class="pricing-item-header pb-24 mb-24">
                                    <div class="pricing-item-price mb-8">
                                        ...
                                        <span class="pricing-item-price-amount text-sm">{{ getPricingData(this.priceOutput.plan1, 2) }}</span>
                                    </div>
                            ...
                            <div class="pricing-item-content">
                                <div class="pricing-item-header pb-24 mb-24">
                                    <div class="pricing-item-price mb-8">
                                        ...
                                        <span class="pricing-item-price-amount text-sm">{{ getPricingData(this.priceOutput.plan2, 2) }}</span>
                                    </div>
                                    <div class="text-xs text-color-low">
                                        Lorem ipsum is a common text
                                    </div>
                            ...
                            <div class="pricing-item-content">
                                <div class="pricing-item-header pb-24 mb-24">
                                    <div class="pricing-item-price mb-8">
                                        ...
                                        <span class="pricing-item-price-amount text-sm">{{ getPricingData(this.priceOutput.plan3, 2) }}</span>
                                    </div>
                                    <div class="text-xs text-color-low">
                                        Lorem ipsum is a common text
                                    </div>
